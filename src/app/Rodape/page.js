...
<div id="Rodape" className=" block mt-20 pt-3 text-black"> 
                  ...
                  <div className="transicao py-10 px-19 bg-white" >
                        ...
                        <div className="gap-8 w-3/3 flex fle-wrap transicao ">
                              ...
                              <div className="w-1/2 transicao py-9 px-5 transicao rounded ">
                                    <h1 className="cor-logo font-semibold text-3xl">CIKA Studio</h1>
                                    <p className=" text-gray-600 py-5 pr-52">Somos uma agência criativa apaixonada por transformar marcas em experiências extraordinárias. Trabalhamos com startups e marcas inovadoras que buscam se destacar no mercado.</p>
                                            ...
                                            <div className="w-[35%] gap-5 flex flex-wrap justify-start pl-5 ">
                                                                <div className="w-1/6 hover:bg-amber-300 h-[50%] cursor-pointer items-center py-3 rounded-xl hover:-mt-2 bg-white px-2 transicao">
                              ...
                              <div className="w-1/2 flex flex-wrap transicao rounded-t-2xl transicao  py-6">
                         ...
                         {/*********************************PRonto para começar o seu projecto*********************************/}
                            <div className="mt-14 W-full flex shadow-xl rounded  border-t-2 border-gray-300 pt-5 justify-center mb-10">
                                <div className="w-[50%] h-[250px] bg-white px-8 py-4 text-center">
                                        <h1 className=" text-2xl font-bold ">Pronto para Começar seu Projeto?</h1>
                                        <p className=" text-gray-500 text-xl mt-3">Entre em contato conosco hoje mesmo e vamos conversar sobre como podemos transformar sua marca em algo extraordinário.</p>
