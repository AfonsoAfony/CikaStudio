                        ...
                        <div className="py-3 pl-2 gap-16 w-full flex flex-wrap transicao">
                                    ...
                                    <div className=" hover-container h-full pb-10  bg-white rounded-3xl w-full lg:w-[46%] xl:w-[30%]  transicao">
                                          ...
                                          <div id="div-conteudo" className="px-5 py-4 transicao">
                                              ...
                                              <h1 className="font-semibold text-xl my-3 transicao">Startup Pitch Deck</h1>  
                                              <p className="text-gray-500 text-sm transicao">Design de apresentação impactante para rodada de investimento, resultando em captação de R$ 2M.</p>
                                    ...
                                    <div className=" hover-container h-full pb-10 bg-white rounded-3xl w-full lg:w-[46%] xl:w-[30%]  transicao">
                                          ...
                                          <div id="div-conteudo" className="px-5 py-4 transicao">
                                              ...
                                              <h1 className="font-semibold text-xl my-3 transicao">EcoShop E-commerce</h1>  
                                              <p className="text-gray-500 text-sm transicao">Interface moderna e sustentável para e-commerce de produtos ecológicos com foco na experiência do usuário. </p>
