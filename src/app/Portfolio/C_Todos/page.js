                        ...
                        <div className="py-3 pl-2 gap-16 w-full flex flex-wrap transicao">
                                    ...
                                    <div className=" hover-container h-full pb-10 bg-white rounded-3xl w-full lg:w-[46%] xl:w-[30%]  transicao">
                                          ...
                                          <div id="div-conteudo" className="px-5 py-4 transicao">
                                              ...
                                              <h1 className="font-semibold text-lg md:text-xl my-3 transicao">FoodTech Social Media</h1>  
                                              <p className="text-gray-500 text-[12px] md:text-sm transicao">Estratégia completa de conteúdo para redes sociais de startup do setor alimentício.</p>
