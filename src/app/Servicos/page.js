...
function Servicos(){
        return(
<div id="Servicos" className=" block mt-32 pt-20  text-black"> 
                  <div className=" px-52">
                        <h1 className="text-center text-6xl font-semibold mb-5">Nossos <span className="cor-logo">Serviços</span></h1>
                        <p className="text-center text-gray-500 text-xl mx-52 ">Oferecemos soluções criativas completas para transformar sua marca em uma experiência memorable e impactante no mercado.</p>
                  </div>
            {/********************************* */}
            <div className="gap-8 w-3/3 h-[400px] flex justify-between transicao pt-10 px-19">
                       ...
                       <div className="group hover:-mt-5 hover:bg-amber-200   border-2 rounded-3xl px-8 border-amber-500 w-1/1 py-5 transicao ">
                        ...
                        <div className=" group hover:-mt-5 hover:bg-amber-200  border-2 rounded-3xl px-8 border-amber-600 w-1/1 py-5 transicao ">
            ...
            {/********************************* */}
            <div className="gap-8 w-3/3 h-[400px] flex justify-between transicao pt-6 px-19">
            ...
            <div className="mt-14 W-full flex justify-center ">
                  <div className="w-[50%] h-[250px] bg-white rounded shadow-xl px-8 py-4 text-center">
                        ...
                        <div className="justify-center flex mt-5">
                               <button className="btn-laranja text-[110%] px-6 py-5 transicao flex gap-2 font-semibold mt-5">VAMOS CONVERSAR SOBRE O PROJECTO<ArrowRight/></button>
                         </div>
                  </div>
